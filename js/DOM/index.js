function index() {
    ...
    for (t = 0; t < 2; t++)
        for (i = 0; i < r[t][1].length; i++) n = document.createElement("audio"), n.id = r[t][0] + r[t][1][i], n.setAttribute('crossorigin', 'anonymous'), n.canPlayType("audio/mpeg;") ? (n.type = "audio/mpeg", n.src = "notes\\" + n.id + ".mp3") : (n.type = "audio/mpeg", n.src = "notes\\" + n.id + ".ogg"), $("audio").appendChild(n)
}
index();